...
export const configs = {
  ...
  JWT_ACTION_VERIFY_PASSWORD_SECRET:
    process.env.JWT_ACTION_VERIFY_PASSWORD_SECRET,
  JWT_ACTION_VERIFY_PASSWORD_EXPIRES_IN:
    process.env.JWT_ACTION_VERIFY_PASSWORD_EXPIRES_IN,
